...
pipeline = '/pipeline_power_law_hyper__lens_bulge_disk_power_law__source_inversion/'
no_shear = 'pipeline_tag__hyper_galaxies__fix_lens_light__pix_voro_image__reg_adapt_bright__bd_align_centre__disk_sersic/' \
           'phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
shear = 'pipeline_tag__hyper_galaxies__with_shear__fix_lens_light__pix_voro_image__reg_adapt_bright__bd_align_centre__disk_sersic/' \
        'phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
...
for i in range(len(lens_name)):
   ...
   # if full_data_path.is_file() and \
    if full_data_path_shear.is_file():
