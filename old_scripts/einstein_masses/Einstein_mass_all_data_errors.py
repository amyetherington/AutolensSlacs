...
data_path = '{}/../../output/slacs_test_runs_prev_to_15.03.19/slacs_cosma_double_sersic_const_off/'.format(os.path.dirname(os.path.realpath(__file__)))
...
for i in range(len(lens_name)):
    full_data_path = Path(data_path + lens_name[i] + '/pipeline_light_and_source_inversion/phase_3_both/model.results')
