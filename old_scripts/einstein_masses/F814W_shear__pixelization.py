...
## choose whether fixed lens light or not
...
## choose shear type test, fix lens light
#shear = 'pipeline_tag__with_shear__fix_lens_light__pix_voro_image__reg_adapt_bright__bd_align_centre/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
shear = 'pipeline_tag__hyper_galaxies_bg_noise__with_shear__fix_lens_light__pix_voro_image__reg_adapt_bright__bd_align_centre__disk_sersic/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
#shear = 'pipeline_tag__hyper_galaxies_bg_noise__with_shear__fix_lens_light__pix_voro_image__reg_adapt_bright__bd_align_centre/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'

## shear type test, not fix lens light
#shear = 'pipeline_tag__with_shear__pix_voro_image__reg_adapt_bright__bd_align_centre/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
#shear = 'pipeline_tag__hyper_galaxies__with_shear__pix_voro_image__reg_adapt_bright__bd_align_centre/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'
#shear = 'pipeline_tag__hyper_galaxies_bg_noise__with_shear__pix_voro_image__reg_adapt_bright__bd_align_centre/phase_4__lens_bulge_disk_sie__source_inversion/phase_tag__sub_2__pos_1.00__cluster_0.100/model.results'

## choose for fix lens light or not
skiprows = 21   #slacs fix lens light
#skiprows = 49    #slacs
...
for i in range(len(lens_name)):
    full_data_path = Path(data_path + lens_name[i] + pipeline + shear)
    if full_data_path.is_file():
        data = pd.read_csv(full_data_path, sep='\s+', header=None, skiprows=skiprows, nrows=9,).set_index(0)
        del data.index.name
