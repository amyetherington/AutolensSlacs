...
data_path = '{}/../../../../output/slacs_shu_1/'.format(os.path.dirname(os.path.realpath(__file__)))
...
fig_path = '/Users/dgmt59/Documents/Plots/slacs_shu_full/'
...
slacs = slacs.drop(['slacs1142+1001'], axis=0)
...
ax.set_xlim(lims)
ax.set_ylim(lims)
plt.savefig(fig_path + 'slopes_shu!', bbox_inches='tight', dpi=300, transparent=True)
